...
- Use I18n::getCurrentLanguage directly in runcmdEx
- Removed useless addUnloadCallback for KVDBClass
- Enter EngineScope in advance in MessageSystem
- Only call LLSECallEventsOnUnload when plugin is under hot unload

## [0.21.2] - 2026-09-15

### Changed

- Added [iListenAttentively](https://github.com/LiteLDev/iListenAttentively) as event library

### Fixed

- Fixed onEndermanTakeBlock

## [0.21.1] - 2026-09-13

### Fixed

- Fixed Player::setBossbar

## [0.21.0] - 2026-09-08

- on onEndermanTakeBlock not available for now
...
- Optimized PlayerHelper::getPreviousLevelRequirement

### Fixed

- Fixed the packet read @zimuya4153
...
[#390]: https://github.com/LiteLDev/LegacyScriptEngine/issues/390

[Unreleased]: https://github.com/LiteLDev/LegacyScriptEngine/compare/v0.22.0...HEAD
[0.22.0]: https://github.com/LiteLDev/LegacyScriptEngine/compare/v0.21.3...v0.22.0
[0.21.3]: https://github.com/LiteLDev/LegacyScriptEngine/compare/v0.21.2...v0.21.3
[0.21.2]: https://github.com/LiteLDev/LegacyScriptEngine/compare/v0.21.1...v0.21.2
[0.21.1]: https://github.com/LiteLDev/LegacyScriptEngine/compare/v0.21.0...v0.21.1
[0.21.0]: https://github.com/LiteLDev/LegacyScriptEngine/compare/v0.20.0...v0.21.0
[0.20.0]: https://github.com/LiteLDev/LegacyScriptEngine/compare/v0.19.7...v0.20.0
