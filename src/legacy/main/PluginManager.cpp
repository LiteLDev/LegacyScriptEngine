...
// auto PluginManager::loadPlugin(std::string_view pluginFilePath) -> bool {
//     ScriptEngine* engine = nullptr;
//     try {
//         // Create script engine
//         engine = EngineManager::newEngine("", false);
...
// Unload plugin
bool PluginManager::unloadPlugin(std::string_view svname) {
