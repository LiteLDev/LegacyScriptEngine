...
public:
    ...
    static NativeFunction::Types getNativeType(demangler::ms_demangle::Node* type);
...
public:
    explicit ScriptNativeFunction(const Local<Object>& scriptObj) : ScriptClass(scriptObj) {}
     ...
     * > NativeFunction.fromDescribe(RetuenValue: NativeTypes.Void, Params:
     * [NativeType.Int......])
     */
     ...
     * > NativeFunction.fromScript(RetuenValue: NativeTypes.Void, Params:
     * [NativeType.Int......], Callback: func(Params...){})
     */
...
public:
    explicit NativePatch(const Local<Object>& scriptObj) : ScriptClass(scriptObj) {}
...
public:
    explicit GlobalNativePointer(const Local<Object>& scriptObj) : ScriptClass(scriptObj) {}
