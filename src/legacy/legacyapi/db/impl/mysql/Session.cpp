...
//     IF_ENDBG lse::LegacyScriptEngine::getInstance().getSelf().getLogger().info("MySQLSession::MySQLSession:
...
//         "utf8"
//     );
//     // IF_ENDBG lse::LegacyScriptEngine::getInstance().getSelf().getLogger().debug("MySQLSession::open: MySQL default
//     charset name:
//     // {}", defaultCharset);
...
//     IF_ENDBG lse::LegacyScriptEngine::getInstance().getSelf().getLogger().debug("MySQLSession::execute: Executing > "
...
//     IF_ENDBG lse::LegacyScriptEngine::getInstance().getSelf().getLogger().debug("MySQLSession::change: Changing user
...
//     IF_ENDBG lse::LegacyScriptEngine::getInstance().getSelf().getLogger().debug("MySQLSession::query: Querying > " +
...
//     IF_ENDBG lse::LegacyScriptEngine::getInstance().getSelf().getLogger().debug("MySQLSession::query: Query returned
...
//         mysql_close(conn);
//         conn = nullptr;
//         IF_ENDBG lse::LegacyScriptEngine::getInstance().getSelf().getLogger().debug("MySQLSession::close: Closed
//         database");
//     }
// }
