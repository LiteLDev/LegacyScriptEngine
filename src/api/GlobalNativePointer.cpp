...
Local<Value>
GlobalNativePointer::getServerNetworkHandlerPtr(const Arguments &args) {
  return NativePointer::newNativePointer(
      ll::service::getServerNetworkHandler());
}

Local<Value>
GlobalNativePointer::getMinecraftCommandsPtr(const Arguments &args) {
  return NativePointer::newNativePointer(
      &ll::service::getMinecraft()->getCommands());
}

Local<Value> GlobalNativePointer::getLevelStoragePtr(const Arguments &args) {
  return NativePointer::newNativePointer(
      &ll::service::getLevel()->getLevelStorage());
}
...
Local<Value>
GlobalNativePointer::getRakNetServerLocatorPtr(const Arguments &args) {
  return NativePointer::newNativePointer(
      &ll::service::getNetworkSystem()->getServerLocator());
}
...
Local<Value> GlobalNativePointer::getScoreboardPtr(const Arguments &args) {
  return NativePointer::newNativePointer(
      &ll::service::getLevel()->getScoreboard());
}
...
Local<Value>
GlobalNativePointer::getPropertiesSettingsPtr(const Arguments &args) {
...
ClassDefine<GlobalNativePointer> GlobalNativePointerBuilder =
    defineClass<GlobalNativePointer>("GlobalPointer")
        ...
        .function("ServerNetworkHandler",
                  &GlobalNativePointer::getServerNetworkHandlerPtr)
        .function("MinecraftCommands",
                  &GlobalNativePointer::getMinecraftCommandsPtr)
        .function("LevelStorage", &GlobalNativePointer::getLevelStoragePtr)
        .function("DBStorage", &GlobalNativePointer::getDBStoragePtr)
        .function("RakNetServerLocator",
                  &GlobalNativePointer::getRakNetServerLocatorPtr)
