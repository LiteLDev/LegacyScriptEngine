...
//         lse::getSelfModInstance().getLogger().debug("AllocateBuffer: Allocated! Buffer size:
//         {}", len);
// #endif
...
//     case MYSQL_TYPE_JSON:
// #if defined(LLDB_DEBUG_MODE)
//         lse::getSelfModInstance().getLogger().debug("ReceiverToAny: string: length: {}, buffer
...
//     case MYSQL_TYPE_LONG_BLOB:
// #if defined(LLDB_DEBUG_MODE)
//         lse::getSelfModInstance().getLogger().debug("ReceiverToAny: blob: length: {}, buffer
//         {}", rec.length, rec.buffer.get());
// #endif
...
//     case MYSQL_TYPE_NEWDECIMAL:
//         // TODO: Decimal
//         lse::getSelfModInstance().getLogger().debug("MySQL_Decimal: {}",
...
//         }
//     }
//     IF_ENDBG lse::getSelfModInstance().getLogger().debug("MySQLStmt::getNextParamIndex: The
...
//     }
//     if (!metadata) {
//         IF_ENDBG lse::getSelfModInstance().getLogger().debug("MySQLStmt::bindResult: No result
//         metadata"); return;
//     }
...
//     IF_ENDBG lse::getSelfModInstance().getLogger().debug("MySQLStmt::bindResult:
...
//         IF_ENDBG lse::getSelfModInstance().getLogger().debug("MySQLStmt::bind: Bound string
...
//     }
//     IF_ENDBG lse::getSelfModInstance().getLogger().debug("MySQLStmt::_Fetch: Fetching
//     row..."); Row      row(resultHeader); IF_ENDBG
//     lse::getSelfModInstance().getLogger().debug("MySQLStmt::_Fetch: RowHeader size
...
// SharedPointer<Stmt> MySQLStmt::create(const std::weak_ptr<Session>& session, const std::string& sql, bool
// autoExecute) {
//     auto s = session.lock();
...
//         lse::getSelfModInstance().getLogger().debug("MySQLStmt::create: Parsed named
//         parameters in query: ");
//         lse::getSelfModInstance().getLogger().debug("MySQLStmt::create: - SQL without named
//         parameters: {}", query); for (auto& [k, v] : params) {
//             lse::getSelfModInstance().getLogger().debug("MySQLStmt::create: - {}: {}", k, v);
//         }
//     }
...
//     if (raw->debugOutput) lse::getSelfModInstance().getLogger().debug("MySQLStmt::create:
