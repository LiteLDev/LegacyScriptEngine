...
//         }
//     }
//     IF_ENDBG lse::LegacyScriptEngine::getInstance().getSelf().getLogger().debug("MySQLStmt::getNextParamIndex: The
...
//     }
//     if (!metadata) {
//         IF_ENDBG lse::LegacyScriptEngine::getInstance().getSelf().getLogger().debug("MySQLStmt::bindResult: No result
//         metadata"); return;
//     }
...
//     IF_ENDBG lse::LegacyScriptEngine::getInstance().getSelf().getLogger().debug("MySQLStmt::bindResult:
...
//         IF_ENDBG lse::LegacyScriptEngine::getInstance().getSelf().getLogger().debug("MySQLStmt::bind: Bound string
...
//     }
//     IF_ENDBG lse::LegacyScriptEngine::getInstance().getSelf().getLogger().debug("MySQLStmt::_Fetch: Fetching
//     row..."); Row      row(resultHeader); IF_ENDBG
//     lse::LegacyScriptEngine::getInstance().getSelf().getLogger().debug("MySQLStmt::_Fetch: RowHeader size
...
//         lse::LegacyScriptEngine::getInstance().getSelf().getLogger().debug("MySQLStmt::create: Parsed named
//         parameters in query: ");
//         lse::LegacyScriptEngine::getInstance().getSelf().getLogger().debug("MySQLStmt::create: - SQL without named
...
//     if (raw->debugOutput) lse::LegacyScriptEngine::getInstance().getSelf().getLogger().debug("MySQLStmt::create:
