...
//   static bool loadPluginPackage(const std::string &dirPath,
//                                 const std::string &packagePath, bool
//                                 isHotLoad, bool isUncompressedFirstTime);

// public:
//   // if mustBeCurrectModule == true and not-current-module plugin is found,
//   will
//   // throw exception
//   static bool loadPlugin(const std::string &fileOrDirPath,
//                          bool isHotLoad = false,
//                          bool mustBeCurrectModule = false);
...
//   static std::unordered_map<std::string, ll::plugin::Plugin *>
//   getLocalPlugins();
//   static std::unordered_map<std::string, ll::plugin::Plugin *>
//   getAllScriptPlugins();
//   static std::unordered_map<std::string, ll::plugin::Plugin *>
...
//   static bool registerPlugin(std::string filePath, std::string name,
