...
ClassDefine<void> McClassBuilder = defineClass("mc")
                                       ...
                                       .function("getEntity", McClass::getEntity)
                                       .function("newItem", &McClass::newItem)
                                       .function("spawnMob", &McClass::spawnMob)
                                       .function("summonMob", &McClass::summonMob)
                                       .function("loadMob", &McClass::loadMob)
                                       ...
                                       .function("getAllPlayerUuids", &McClass::getAllPlayerUuids)
