...
protected:
  ...
  HttpServerCallback errorCallback, exceptionCallback, preRoutingCallback,
      postRoutingCallback;
...
public:
  HttpRequestClass(const Local<Object> &scriptObj,
...
public:
  HttpResponseClass(const Local<Object> &scriptObj,
