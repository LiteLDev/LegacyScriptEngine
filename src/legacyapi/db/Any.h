 ...
 */
template <typename T> inline T any_to(const DB::Any &v) {
  throw std::bad_cast();
}
...
template <typename T>
inline std::unordered_set<DB::Any>
to_any_container(const std::unordered_set<T> &v);
template <typename K, typename V>
inline std::map<K, DB::Any> to_any_container(const std::map<K, V> &v);
template <typename K, typename V>
inline std::unordered_map<K, DB::Any>
to_any_unordered_map(const std::unordered_map<K, V> &v);
...
public:
   ...
   * @see    is_number()
   */
  template <typename T> inline T get_number() const {
    switch (type) {
   ...
   * @see any_to
   */
  template <typename T> inline T get() const { return any_to<T>(*this); }
  /**
   ...
   */
  template <> inline char get() const { return get_number<char>(); }
  /**
   ...
   */
  template <> inline unsigned char get() const {
   ...
   */
  template <> inline short get() const { return get_number<short>(); }
  /**
   ...
   */
  template <> inline unsigned short get() const {
   ...
   */
  template <> inline int get() const { return get_number<int>(); }
  /**
   ...
   */
  template <> inline unsigned int get() const {
   ...
   */
  template <> inline long get() const { return get_number<long>(); }
  /**
   ...
   */
  template <> inline unsigned long get() const {
   ...
   */
  template <> inline long long get() const { return get_number<long long>(); }
  /**
   * @brief Get the value as unsigned long long
   *
   * @tparam T                   = unsigned long long
   * @return unsigned long long  The value
   * @throws std::bad_cast       If the value cannot be converted to unsigned
   * long long
   */
  template <> inline unsigned long long get() const {
   ...
   */
  template <> inline double get() const { return get_number<double>(); }
  /**
   ...
   */
  template <> inline float get() const { return get_number<float>(); }
  /**
   * @brief Get the value as string.
   *
   * @tparam T              = std::string
   ...
   */
  template <> ByteArray get() const {
    switch (type) {
    case Type::Blob:
      return *value.blob;
    case Type::String:
      return ByteArray((unsigned char *)value.string->data(),
                       (unsigned char *)value.string->data() +
                           value.string->size());
    case Type::Integer:
    case Type::UInteger:
    case Type::Floating:
